                            ...
                            <?php foreach ($list_news as $item): ?>
                                <div class="post">
                                    <div class="post-header">
                                        <a class="category" href="<?php echo base_url('tin-tuc/'.$item->loaitintuc_slug); ?>"><?php echo $item->loaitintuc_name; ?></a>
                                    ...
                                    <div class="post-content">
                                        <div class="col-md-3 col-xs-12">
                                            <a class="featured-img" href="<?php echo base_url('tin-tuc/'.$item->loaitintuc_slug.'/'.$item->slug); ?>">
                                        ...
                                        <div class="col-md-9 col-xs-12">
                                            ...
                                            <div class="read-more">
                                                <a class="pull-left" href="<?php echo base_url('tin-tuc/'.$item->loaitintuc_slug.'/'.$item->slug); ?>">
