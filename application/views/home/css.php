 ...
 * -- CODE: ----------------------------------------------
 *
 *    $str .= file_get_contents('test.css'));
 *
 * -------------------------------------------------------
 */
...
?>
<?php //$str = file_get_contents(base_url('public/css/libs/ionicons.min.css'));?>
<?php $str = file_get_contents(base_url('public/css/libs/jquery.fancybox.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/jquery-ui.min.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/owl.carousel.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/owl.transitions.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/jquery.mCustomScrollbar.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/owl.theme.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/slick.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/animate.css'));?>
<?php $str .= file_get_contents(base_url('public/css/libs/hover.css'));?>
<?php $str .= file_get_contents(base_url('public/css/color3.css'));?>
<?php $str .= file_get_contents(base_url('public/css/responsive.css'));?>
<?php $str .= file_get_contents(base_url('public/css/browser.css'));?>
<?php $file = "./public/css/dp.css"; file_put_contents($file, minify_css($str)); ?>

<?php $str_them .= file_get_contents(base_url('public/css/theme.css'));?>
<?php $filethem = "./public/css/thememini.css"; file_put_contents($filethem, minify_css($str_them)); ?>