...
<div class="wrap">
    ...
    <section id="content">
        <div class="container">
            <div class="intro-featured-product text-center">
                <div class="container">
                    <h2 class="title30 title-box18 lob-font text-center color2">TRANG 404</h2>
                    <a href="#" class="push"><img src="<?php echo base_url(); ?>public/images/home/home7/feature.png" alt=""></a>
                    <p class="desc">KHÔNG TÌM THẤY TRANG HOẶC SẢN PHẨM KHÔNG TỒN TẠI</p>
                    <p class="desc">Vui lòng quay lại trang chủ hoặc xem sản phẩm khác !!!</p>
                    <a href="<?php echo base_url('san-pham'); ?>" class="shop-button large bg-color">Mua Hàng Tiếp <i class="icon ion-ios-arrow-thin-right"></i></a>
                </div>
            </div>
        </div>
    </section>
