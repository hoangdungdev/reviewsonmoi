	...
	<table class="sz-grid">
		...
		<tbody>
			...
			<tr id=<?php echo $row->id;?>>
				...
				<td class="left">
					<a href="<?php echo site_url().$module."/".$controller."/edit/".$row->id?>"><?php echo $row->title;?></a>
					<div class="action">
						<span><a class="edit" href="<?php echo site_url().$module."/".$controller."/edit/".$row->id?>">Edit</a> | </span>
						<span><a class="del" href="<?php echo site_url().$module."/".$controller."/delete/".$row->id?>">Delete</a> </span> </span>
					</div>
				</td>
				<td><img src="<?php echo base_url();?>upload/tintuc/thumb/<?php echo $row->image;?>" width=50"/></td>
				<td><?php echo $row->created;?></td>
				<td><?php echo $row->modified;?></td>
				<td><?php echo $row->modified_by;?></td>
				<td class="livestatus" style="cursor: pointer"><?php if($row->status == 1) echo '<span class="true">Public</span>';else if($row->status == -1) echo '<span class="false">Draff</span>'?></td>
