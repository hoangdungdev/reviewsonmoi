			...
			<tr id=<?php echo $row->id;?>>
				...
				<td class="left">
					...
					<div class="action">
						...
						<!-- <span><a class="view" target="_blank" href="<?php echo site_url().$row->slug?>">Preview</a> </span> </span> -->
					</div>
				</td>
				<!-- <td><?php echo $row->post_category_name;?></td>
				<td><img src="<?php echo base_url();?>upload/post/thumb/<?php echo $row->image;?>"/></td> -->
